...
Toolskin is a production-ready, highly configurable CSS + JavaScript design framework with integrated smooth scrolling, parallax effects, automatic theme management, and zero-config setup.

### Key Features

✅ **Smooth Scrolling** - Lenis integration with anchor navigation  
✅ **Parallax Effects** - Locomotive Scroll with auto-detection  
✅ **Auto Light/Dark Theme** - Automated theme conversion  
✅ **Configurable Layout** - Container width, noise, fullpage modes  
✅ **Zero Dependencies** - Optional CDN integrations  
✅ **Performance First** - Reduced motion support, lazy loading  

---

## 📦 Quick Start

### 1. Basic Setup (No Configuration)
